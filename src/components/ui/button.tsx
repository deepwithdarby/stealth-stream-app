  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cyber: "bg-gradient-primary text-white hover:shadow-glow-primary transition-smooth border border-primary/20",
        hero: "bg-gradient-cyber text-white hover:scale-105 shadow-glow-primary text-lg font-bold",
        glass: "glass text-foreground hover:bg-white/10 border border-white/20",
        accent: "bg-accent text-accent-foreground hover:bg-accent/80 shadow-glow-accent",
      },
      size: {
